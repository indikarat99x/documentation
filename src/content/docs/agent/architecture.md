---
title: Architecture
description: Architecture objectives, overall flow, and sequence diagrams for the Xianix Agent.
---
...
```
GitHub/Azure DevOps → Xians ACP → Agent .NET Console Application → Orchestrator

Orchestrator → Via rules.json (Filter Events, Extract Inputs, Identify Claude Code Plugin to Invoke) → Signal XianixWorkflow
